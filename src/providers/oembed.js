import GithubGist from './gist.js'
...
export const oEmbedProviders = [
  ...
  },
  {
    ...
    endpoints: [
      {
        schemes: ['https://www.gumlet.com/watch/*', 'https://play.gumlet.io/embed/*'],
  ...
  },
  {
    ...
    endpoints: [
      {
        schemes: ['https://ndla.no/*'],
        url: 'https://ndla.no/oembed',
        discovery: false,
      },
      {
        schemes: ['https://liste.ndla.no/*'],
...
export const additionalOEmbedProviders = [
  {
    provider_name: 'Anchor',
    provider_url: 'https://anchor.fm',
    endpoints: [
      {
        schemes: ['https://anchor.fm/*'],
        url: 'https://anchor.fm',
        discovery: true,
      },
    ],
